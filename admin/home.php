  ...
  $stmt->execute();
		 ...
		 <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
              <?php
 $stmt = $conn->prepare("SELECT *, COUNT(*) AS numrows FROM sub_catagory");
  $stmt->execute();
                $urow =  $stmt->fetch();
            ...
            <a href="subcategory.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
