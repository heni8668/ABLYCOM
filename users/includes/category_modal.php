              ...
              <form class="form-horizontal" method="POST" action="category_add.php">
                <div class="form-group">
				 ...
				 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="name" name="cat_slug" required>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="category_edit.php">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                    <label for="edit_name" class="col-sm-3 control-label">Type</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_name" name="cat_slug">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
